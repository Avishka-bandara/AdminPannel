        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="Auth::user()->usertype == 'admin' ? route ('admin.dashboard') : route ('dashboard') " : active="Auth::user()->usertype == 'admin' ? route('admin.dashboard') : route ('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </div>
            </div>
            ...
            <x-nav-link href="#" : active=" request()->routeIs('user.order')">
                {{ __('Order') }}
            </x-nav-link>
    

            <x-nav-link href="#" : active=" request()->routeIs('user.favorite')">
                {{ __('Favorite') }}
            </x-nav-link>
